...
const legalLinks: linkType[] = [
  { link: "/Payment#legal-point1", name: "DELIVERY METHOD" },
  { link: "/Payment#legal-point2", name: "MINIMUM ORDER" },
  { link: "/Payment#legal-point3", name: "NECESSARY FOR THE BUYER" },
  { link: "/Payment#legal-point4", name: "RULES DESTINATION" },
  { link: "/Payment#legal-point5", name: "FREE PACKING" },
];
